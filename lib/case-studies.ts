...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    story: [
      ...
      "Adam was on the Loudachris full-service plan ($1,500+/mo SEO management plus the original site build) — not the free-website subscription. The same SEO approach and team builds free-websites.com.au sites at the $297-$497/mo price point.",
    ],
    meta: {
      title:
  ...
  },
  {
    ...
    story: [
      ...
      "Ali was on the Loudachris full-service plan, not the free-website subscription. The same approach and team builds free-website.com.au sites at the $297-$497/mo price point.",
    ],
    meta: {
      title:
